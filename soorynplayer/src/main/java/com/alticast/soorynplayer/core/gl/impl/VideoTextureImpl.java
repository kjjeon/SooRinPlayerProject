package com.alticast.soorynplayer.core.gl.impl;
...
import com.alticast.soorynplayer.core.gl.TextureHandle;
...
public class VideoTextureImpl implements SurfaceTexture.OnFrameAvailableListener, VideoTexture {
    ...
    private static final String TAG = "VideoTextureImpl";
