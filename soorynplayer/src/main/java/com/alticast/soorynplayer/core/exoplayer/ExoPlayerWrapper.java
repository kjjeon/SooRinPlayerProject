package com.alticast.soorynplayer.core.exoplayer;
...
import com.alticast.soorynplayer.core.exoplayer.source.TsDataSourceFactory;
import com.alticast.soorynplayer.utils.Constants;
...
public class ExoPlayerWrapper implements MediaPlayer {
    ...
    public synchronized int playback(SurfaceHolder surfaceHolder, int rawResourceId) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(context,
                Util.getUserAgent(context, "SooRynPlayer"));
...
//                .createMediaSource(Uri.parse("mcast://233.18.158.206:5000"));
    ...
    public synchronized int playback(SurfaceTexture surfaceTexture) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultHttpDataSourceFactory(Util.getUserAgent(context, "SooRynPlayer"));
